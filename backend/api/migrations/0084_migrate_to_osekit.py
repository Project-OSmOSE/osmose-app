# Generated by Django 3.2.25 on 2025-07-15 15:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql="INSERT INTO api_spectrogram (analysis_id, filename, format_id, start, \"end\") SELECT c.id, substring(f.filename, 0, position('.' in f.filename)), (SELECT id FROM metadatax_data_fileformat WHERE name='png'), f.start, f.end FROM dataset_files f LEFT JOIN datasets d on d.id = f.dataset_id            LEFT JOIN api_spectrogramconfiguration c on c.dataset_id = d.id;          ",
            reverse_sql="",
        ),
        migrations.CreateModel(
