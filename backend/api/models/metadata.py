...
class SpectroConfig(models.Model):
    ...
    HPfilter_min_freq = models.IntegerField()
    colormap = models.CharField(max_length=255, unique=True)
    dynamic_min = models.IntegerField()
    dynamic_max = models.IntegerField()
    window_type = models.CharField(max_length=255, unique=True)
    frequency_resolution = models.IntegerField()
    time_resolution_zoom_0 = models.IntegerField()
    time_resolution_zoom_1 = models.IntegerField()
    time_resolution_zoom_2 = models.IntegerField()
    time_resolution_zoom_3 = models.IntegerField()
    time_resolution_zoom_4 = models.IntegerField()
    time_resolution_zoom_5 = models.IntegerField()
    time_resolution_zoom_6 = models.IntegerField()
    time_resolution_zoom_7 = models.IntegerField()
    time_resolution_zoom_8 = models.IntegerField()
