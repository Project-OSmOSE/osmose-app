...
from backend.api.serializers import AnnotationCampaignCreateSerializer, AnnotationCampaignAddAnnotatorsSerializer
...
class AnnotationCampaignCreateSerializerTestCase(TestCase):
    ...
    def test_with_wrong_spectros(self):
        ...
        create_serializer = AnnotationCampaignCreateSerializer(campaign, data=update_data)
...
class AnnotationCampaignAddAnnotatorsSerializerTestCase(TestCase):
    ...
    def test_with_valid_data(self):
        ...
        update_serializer = AnnotationCampaignAddAnnotatorsSerializer(campaign, data=self.add_annotators_data)
        update_serializer.is_valid(raise_exception=True)
        update_serializer.save()
        campaign.refresh_from_db()
        self.assertEqual(new_annotator.annotation_tasks.count(), old_user_count + files_target)
    ...
    def test_without_annotation_goal(self):
        ...
        update_serializer = AnnotationCampaignAddAnnotatorsSerializer(campaign, data=add_annotators_data)
        update_serializer.is_valid(raise_exception=True)
        update_serializer.save()
        campaign.refresh_from_db()
