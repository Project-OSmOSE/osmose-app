...
class UserViewSetTestCase(APITestCase):
    ...
    def test_list(self):
        ...
        self.assertEqual(dict(response.data[0]), {'id': 1, 'username': 'admin', 'email': 'admin@osmose.xyz'})
    ...
    def test_create_for_staff(self):
        ...
        self.assertEqual(dict(response.data), {'id': 6, 'username': 'new_user', 'email': 'user@example.com'})
