...
// CETIROISE imgs
import sponsoCetiroiseImg from '../../img/projects/sponso-cetiroise.png';
    ...
    <div id="projects-page">
      ...
      <div className="container">
        ...
        <article className="my-5">
          ...
          <p>
            The Iroise Naturall Marine Park hosts 2 coastal bottlenose dolphin population, but it is also an important area for other cetacean species such as common dolphins, harbour porpoises, fin whales, risso’s dolphins, pilot whales, … These species are threatened by bycatching, disturbances, noise pollution, ship strikes, … Knowledge on these species is still difficult to acquire. It is also almost non-existent for large cetaceans, which seem to be more and more present in the offshore part of the marine park. A good understanding of the key role of this area for cetaceans requires the deployment of different monitoring tools simultaneously. Passive acoustic monitoring allows a spatial and temporal study of different cetacean species by recording and analysing the sounds they emit. Moreover, the Iroise sector has been identified as a target sector for the study of coastal marine mammal populations by passive acoustics in the proposals for the second cycle of the European strategy for the marine environment monitoring program.
          </p>
          <p>
            In order to improve knowledge about the occurrence and seasonal distribution of cetaceans in the Iroise sea, the Iroise Marine Natural Park and ENSTA Bretagne have launched, in 2021, the CETIROISE program funded under the French economic recovery plan.
          </p>
          <p>
            CETIROISE plans to deploy 7 autonomous instruments with hydrophones in the northern sector of the park for a full year of recording starting in May 2022. Each sites will be equipped with a mooring system who included 2 types of instruments, one dedicated to record small cetaceans (echolocation clicks loggers) and the second allowing the recording of all species (broadband recorder). This is the first time that the occurences of large cetaceans such as minke whales, fin whales or humpback whales can be recorded in the Iroise which seems to be a migratory crossroads for these species. 
          </p>
          <figure>
            <img 
              src={cetiroiseImg} 
          ...
          <figure>
            ...
            />
            <figcaption className="small fst-italic">
              Short mooring line equipped with 2 instruments (intervention by divers). @Yannis Turpin – PNMI
            </figcaption>
          </figure>
          <figure>
            <img 
        ...
        <article className="my-5">
          <h2>Optimization of Cetacean Monitoring by Passive Acoustics (OSCAP)</h2>
