...
export const Member: React.FC = () => {
    ...
    return (
        <div id="member-page">
            ...
            <div className="links">
                {member?.researchGateURL && <a href={member.researchGateURL} target="_blank">ResearchGate</a>}

                {member?.personalWebsiteURL && <a href={member.personalWebsiteURL} target="_blank">Personnal website</a>}
                ...
                <div className="socials">
                    ...
                    {member?.mailAddress &&
                        <a href={`mailto:${member.mailAddress}`} target="_blank">
