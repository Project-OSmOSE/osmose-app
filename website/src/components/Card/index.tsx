    ...
    <div className="genericCard my-5">
      ...
      <div className="card genericCard my-3 border-0">
        <div className="row">
          ...
          { img && imgSide === 'left' ?
            <div className="col-md-4 d-flex align-items-center justify-content-center order-2 order-md-0">
              <img className="card-img shadow" src={ img } alt={ imgAlt } title={ imgAlt }/>
            </div> : null }

          { img && imgSide === 'right' ?
            <div className="col-md-4 d-flex align-items-center justify-content-center order-2">
              <img className="card-img shadow" src={ img } alt={ imgAlt } title={ imgAlt }/>
            </div> : null }
